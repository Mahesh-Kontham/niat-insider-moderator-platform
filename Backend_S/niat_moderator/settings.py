"""
Django settings for NIAT Insider Moderator Platform
"""
...
ROOT_URLCONF = 'niat_moderator.urls'
...
WSGI_APPLICATION = 'niat_moderator.wsgi.application'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@niatinsider.com')

# Frontend URL
FRONTEND_URL = env('FRONTEND_URL', default='http://localhost:5173')

# Invite Token Settings
INVITE_TOKEN_EXPIRY = int(env('INVITE_TOKEN_EXPIRY', default=86400))  # 24 hours
